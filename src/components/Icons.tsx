...
export const IconCoffee = () => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className="w-5 h-5 mr-1 text-deep-blue flex-shrink-0"
  >
    <>
      <path d="M10 2v2" />
      <path d="M14 2v2" />
...
export const IconCircleColor = () => (
  ...
  >
    <path
      fill="#FF6B6B"
      d="M12 3C7.58 3 4 6.58 4 11c0 4.42 3.58 8 8 8s8-3.58 8-8c0-4.42-3.58-8-8-8zm0 14c-3.31 0-6-2.69-6-6 0-3.31 2.69-6 6-6s6 2.69 6 6c0 3.31-2.69 6-6 6z"
    />
    <path
      fill="#87CEEB"
      d="M12 5C8.69 5 6 7.69 6 11c0 3.31 2.69 6 6 6s6-2.69 6-6c0-3.31-2.69-6-6-6z"
    />
    <path
      fill="#FFD700"
      d="M12 7c-2.21 0-4 1.79-4 4 0 2.21 1.79 4 4 4s4-1.79 4-4c0-2.21-1.79-4-4-4z"
    />
  </svg>
);
